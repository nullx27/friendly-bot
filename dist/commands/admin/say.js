...
var AdminCommand_1 = require("../../core/base/AdminCommand");
...
var Say = /** @class */ (function (_super) {
    ...
    Say.prototype.handle = function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var str, regex, chunks, channel, client, msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        client = this.container.get('discord');
                        if (regex.test(chunks[1])) {
                            ...
                            // @ts-ignore
                            channel = client.channels.find(function (x) { return x.name === chunks[1]; });
                        }
                        if (!channel)
