...
var RemindMe = /** @class */ (function (_super) {
    ...
    RemindMe.prototype.init = function () {
        this.container.get('scheduler').addTask(new remindme_1.RemindMeTask(3000));
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.container.get('db').pull('remindme')];
                    case 1:
                        storage = _a.sent();
                        ...
                        return [4 /*yield*/, this.container.get('db').set('remindme', storage)];
                    case 2:
                        _a.sent();
