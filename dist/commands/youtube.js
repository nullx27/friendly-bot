...
var YouTube_1 = require("../fetcher/YouTube");
...
var Youtube = /** @class */ (function (_super) {
    ...
    Youtube.prototype.help = function () {
    ...
    Youtube.prototype.handle = function (message, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, YouTube_1.YouTube(args.join(' '))];
                    case 1:
                        data = _a.sent();
                        reply = new Reply_1.Reply(message).setTitle('YouTube');
    ...
    Youtube = __decorate([
        Decorators_1.trigger('youtube', 'y')
    ], Youtube);
    return Youtube;
}(Command_1.Command));
