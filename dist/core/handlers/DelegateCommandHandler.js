...
var DelegateCommandHandler = /** @class */ (function () {
    function DelegateCommandHandler() {
        // @ts-ignore
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (message.channel.id in this.restricted)
                            return [2 /*return*/];
                        _a = this.parse(message.content), trigger = _a[0], args = _a[1];
                        if (trigger === 'help') {
                            if (!args[0]) {
    ...
    DelegateCommandHandler.prototype.parse = function (message) {
