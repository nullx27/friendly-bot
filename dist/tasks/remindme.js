...
var RemindMeTask = /** @class */ (function (_super) {
    ...
    RemindMeTask.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var storage, remove, _a, _b, _i, i, _c, _d, index;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.bot.db.pull('remindme')];
                    case 1:
                        storage = _e.sent();
                        remove = [];
                        _a = [];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.sendNotification(storage[i])];
                    case 3:
                        _e.sent();
                        remove.push(i);
                        _e.label = 4;
    ...
    RemindMeTask.prototype.sendNotification = function (reminder) {
        return __awaiter(this, void 0, void 0, function () {
            var user, dmchannel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bot.client.fetchUser(reminder.user)];
                    case 1:
                        user = _a.sent();
